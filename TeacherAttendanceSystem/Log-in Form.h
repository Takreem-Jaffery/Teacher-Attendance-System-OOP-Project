...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->llForgotPassword = (gcnew System::Windows::Forms::LinkLabel());
			this->SuspendLayout();
			// 
			// label1
			// 
			...
			this->label1->Size = System::Drawing::Size(737, 57);
			...
			// tbID
			// 
			this->tbID->Anchor = static_cast<System::Windows::Forms::AnchorStyles>((((System::Windows::Forms::AnchorStyles::Top | System::Windows::Forms::AnchorStyles::Bottom)
				| System::Windows::Forms::AnchorStyles::Left)
				| System::Windows::Forms::AnchorStyles::Right));
			this->tbID->BackColor = System::Drawing::SystemColors::ControlLightLight;
			this->tbID->Location = System::Drawing::Point(170, 130);
			this->tbID->Name = L"tbID";
			this->tbID->Size = System::Drawing::Size(567, 38);
			...
			this->label3->Location = System::Drawing::Point(15, 234);
			...
			this->tbPassword->Anchor = static_cast<System::Windows::Forms::AnchorStyles>((((System::Windows::Forms::AnchorStyles::Top | System::Windows::Forms::AnchorStyles::Bottom)
				| System::Windows::Forms::AnchorStyles::Left)
				| System::Windows::Forms::AnchorStyles::Right));
			this->tbPassword->Location = System::Drawing::Point(170, 228);
			this->tbPassword->Name = L"tbPassword";
			this->tbPassword->PasswordChar = '*';
			this->tbPassword->Size = System::Drawing::Size(567, 38);
			...
			this->btnEnter->BackColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(255)), static_cast<System::Int32>(static_cast<System::Byte>(128)),
				static_cast<System::Int32>(static_cast<System::Byte>(128)));
			this->btnEnter->Location = System::Drawing::Point(21, 355);
			this->btnEnter->Name = L"btnEnter";
			this->btnEnter->Size = System::Drawing::Size(185, 52);
			this->btnEnter->TabIndex = 5;
			this->btnEnter->Text = L"Enter";
			this->btnEnter->UseVisualStyleBackColor = false;
			this->btnEnter->Click += gcnew System::EventHandler(this, &LoginForm::btnEnter_Click);
			// 
			// btnCancel
			// 
			...
			this->btnCancel->BackColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(255)), static_cast<System::Int32>(static_cast<System::Byte>(128)),
				static_cast<System::Int32>(static_cast<System::Byte>(128)));
			this->btnCancel->Location = System::Drawing::Point(543, 355);
			this->btnCancel->Name = L"btnCancel";
			this->btnCancel->Size = System::Drawing::Size(200, 52);
			...
			// llSignup
			// 
			this->llSignup->Anchor = static_cast<System::Windows::Forms::AnchorStyles>((System::Windows::Forms::AnchorStyles::Bottom | System::Windows::Forms::AnchorStyles::Right));
			this->llSignup->AutoSize = true;
			this->llSignup->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 16.2F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->llSignup->Location = System::Drawing::Point(624, 426);
			this->llSignup->Name = L"llSignup";
			this->llSignup->Size = System::Drawing::Size(113, 32);
			this->llSignup->TabIndex = 7;
			...
			this->label4->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label4->Location = System::Drawing::Point(401, 433);
			...
			// llForgotPassword
			// 
			this->llForgotPassword->Anchor = static_cast<System::Windows::Forms::AnchorStyles>((System::Windows::Forms::AnchorStyles::Bottom | System::Windows::Forms::AnchorStyles::Right));
			this->llForgotPassword->AutoSize = true;
			this->llForgotPassword->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->llForgotPassword->Location = System::Drawing::Point(532, 281);
			this->llForgotPassword->Name = L"llForgotPassword";
			this->llForgotPassword->Size = System::Drawing::Size(211, 25);
			this->llForgotPassword->TabIndex = 9;
			this->llForgotPassword->TabStop = true;
			this->llForgotPassword->Text = L"Forgot your password\?";
			this->llForgotPassword->LinkClicked += gcnew System::Windows::Forms::LinkLabelLinkClickedEventHandler(this, &LoginForm::llForgotPassword_LinkClicked);
			// 
			// LoginForm
			// 
...
#pragma endregion
	...
	private: System::Void btnEnter_Click(System::Object^ sender, System::EventArgs^ e) {
		String^ teacherID = this->tbID->Text;
		String^ password = this->tbPassword->Text;

		if (teacherID->Length == 0 || password->Length == 0) {
			MessageBox::Show("Please enter the Teacher ID and Password", "Teacher ID or Password Empty", MessageBoxButtons::OK);
			return;
		}
		...
		try {
			...
			String^ sqlQuery = "SELECT * FROM teachers WHERE TeacherID=@teacherID AND Password=@password";
			...
			if (reader->Read()) {
				...
				user->setTeacherID(reader->GetString(1));
				user->setName((reader->GetString(2)));
				user->setEmail((reader->GetString(3)));
				user->setPassword((reader->GetString(4)));
				this->Close();
			}
			else {
				MessageBox::Show("Teacher ID or Password is incorrect", "Teacher ID or Password Error", MessageBoxButtons::OK);
			}
		}
		catch (Exception^ e) {
	...
	private: System::Void llForgotPassword_LinkClicked(System::Object^ sender, System::Windows::Forms::LinkLabelLinkClickedEventArgs^ e) {
		TeacherAttendanceSystem::ForgotPassword forgotPass;
